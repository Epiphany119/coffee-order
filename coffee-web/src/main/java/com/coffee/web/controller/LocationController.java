...
public class LocationController {
    ...
    @PostMapping("/user")
    public Map<String,Object> save(@RequestBody LocationRequest request){AccessGuard.requireUser(request.getUserId());locationService.saveUserLocation(request);return Map.of("success",true);}
